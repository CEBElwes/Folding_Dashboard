...
## Read in data
ddg_info = pd.read_csv("/mnt/azurefile/foldingdashboardNOTCH1/ddg_infoNOTCH1.csv")
gene_pdbs = pd.read_csv("/mnt/azurefile/foldingdashboardNOTCH1/gene_pdbsNOTCH1.csv")
